...
|---|---|---|
| `E` | Mostly `Cmd + key`, with a few remaps/blocks | `E+U` select all, `E+A/E+M/E+R` blocked, `E+C` copy, `E+V` paste, `E+W` close tab, `E+L` focus URL, `E+Tab` app switch, `E+D` blocked in browsers, `E+N` blocked in browsers + Scrivener |
